                            ...
                            <div id="employer">
                                <div class="form-row-flex">
                                    <div class="form-group mr-20">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name="website" class="form-control" placeholder="Enter Company Offcial Website">
                                            <i class="theme-cl ti-world"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name"linkedIn" class="form-control" placeholder="Enter Your Company LinkedIn">
                                            <i class="theme-cl ti-link"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row-flex">
                                    <div class="form-group mr-20">
                                        ...
                                        <div class="input-with-icon-verify">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name"hq" class="form-control" placeholder="HQ Location (City, Country)">
                                ...
                                <div class="form-row-flex">
                                    <div class="form-group mr-20">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name="industry" class="form-control" placeholder="Industry Type (Software, Marketing, etc.)">
                                ...
                                <div class="form-row-flex">
                                    <div class="form-group mr-20">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name="work-contact" class="form-control" placeholder="(e.g.+88012345675)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-icon">
                                            <input type="text" name"tax-id" class="form-control" placeholder="(eg: 00XX-XXX-XXXX)">
                                            <i class="theme-cl ti-file"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="register-account text-center">
                                    By hitting the <span class="theme-cl">"Submit Credentials"</span> button, you agree to the <a class="theme-cl" href="#">Terms conditions</a> and <a class="theme-cl" href="#">Privacy Policy</a>
                                </div>

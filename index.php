...
<body>
	...
	<div class="wrapper">
		...
		<div class="hero-banner" data-ride="carousel" data-pause="hover" data-interval="false" >
			<!-- <div class="hero-img">
				<img src="http://via.placeholder.com/1920x850" class="img-responsive" alt="">
			</div> -->
			<div class="container">
				<div class="row">
					<div class="col col-md-12 col-sm-12">
						<div class="content">
							<h2>The only Bangladeshi job <br> platform built for tech talent</h2>
							<p>Curated, spam-free, and community-driven. We’re building Bangladesh’s first curated job portal for tech. Early partners get  <span>3 free<br>listings and feature placement</span>.</p>
		...
		<div class="company-brand">
			<div class="container">
				<div id="company-brands">
					<div class="brand-img">
						<img src="assets/img/microsoft-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/img-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/mothercare-hom-darke.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/paypal-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/serv-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/xerox-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/yahoo-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="assets/img/mothercare-hom-darke.png" class="img-responsive" alt="" />
					</div>
									...
									<div class="brows-job-half">
										<div class="item-fl-box">
											<div class="brows-job-company-img">
												<a href="job-detail-2.html"><img src="http://via.placeholder.com/150x150" class="img-responsive" alt="" /></a>
											</div>
